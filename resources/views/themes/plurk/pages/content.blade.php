...
@section('content')
    <div class="-mt-[82px] flex-grow overflow-x-hidden lg:-mt-[106px]">
        <div class="bg-cover bg-bottom bg-no-repeat pt-[82px] lg:pt-[106px]" style="background-image: url('{{ asset('assets/images/inner-page-hero-bg.png') }}');">
            <div class="relative">
                <div class="container">
                    <div class="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
                        ...
                        <div class="relative mt-6 md:mt-0" data-aos="fade-left" data-aos-duration="1000">
                            <svg
                                width="352"
                                height="282"
                                viewBox="0 0 352 282"
                                ...
                                class="mx-auto w-72 rtl:rotate-y-180 md:mx-0 md:w-auto"
                            >
                                <path
                                ...
                                />
                                <path
                                    d="M288.699 136.955L293.653 129.924"
                                    stroke="white"
                                    stroke-width="0.75"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                ...
                                />
                                <path
                                    d="M248.576 194.385L264.28 171.916"
                                    stroke="white"
                                    stroke-width="0.75"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                ...
                                />
                                <path
                                    d="M180.889 192.212L196.101 189.513"
                                    stroke="white"
                                    stroke-width="0.75"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                />
                                <path
                                    d="M187.162 183.238L189.826 198.486"
                                    stroke="white"
                                    stroke-width="0.75"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                />
                                <path
                                    d="M275.777 221.13L297.054 217.38"
                                    stroke="white"
                                    stroke-width="0.75"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                />
                                <path
                                    d="M284.541 208.616L288.292 229.928"
                                    stroke="white"
                                    stroke-width="0.75"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                ...
                                />
                                <path
                                    d="M135.215 116.498L137.244 116.738"
                                    stroke="white"
                                    stroke-width="0.75"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                ...
                                />
                                <path
                                    d="M301.277 159.925L328.198 154.211"
                                    stroke="white"
                                    stroke-width="0.75"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
        ...
        <div class="py-14 md:py-[100px]">
            ...
            <div class="container">
                <div class="pb-12">
                    <h4 class="pb-5 text-xl font-bold text-black dark:text-white sm:text-2xl">Terms and Conditions</h4>
                    ...
                    <p class="pb-5 text-lg font-medium">
                        ...
                        of careers.padme.com, life. padme.com & blog.padme.com website.
                    </p>
                    <p class="pb-5 text-lg font-medium">
                    ...
                    <p class="pb-5 text-lg font-medium">
                        By accessing this website we assume you accept these terms and conditions. Do not continue to use Website Name if you do not
                ...
                <div class="pb-12">
                    <h4 class="pb-5 text-xl font-bold text-black dark:text-white sm:text-2xl">Cookies</h4>
                    <p class="pb-5 text-lg font-medium">
                ...
                <div class="pb-12">
                    <h4 class="pb-5 text-xl font-bold text-black dark:text-white sm:text-2xl">License</h4>
                    <p class="pb-5 text-lg font-medium">
                        ...
                        Name. All intellectual property rights are reserved. You may access this from Website Name for your own personal use subjected
                        to restrictions set in these terms and conditions.
                    </p>
                    <h6 class="pb-2 font-semibold text-black">You must not:</h6>
                    <ul class="pb-5 text-lg font-medium">
                        <li
                    ...
                    <p class="pb-5 text-lg font-medium">This Agreement shall begin on the date hereof.</p>
                    <p class="pb-5 text-lg font-medium">
                        ...
                        website. Company Name does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not
                        reflect the views and opinions of Company Name,its agents and/or affiliates. Comments reflect the views and opinions of the
                        person who post their views and opinions.
                    </p>
                    <p class="pb-5 text-lg font-medium">
                        Company Name reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate,
                    ...
                    <h6 class="pb-2 font-semibold text-black">You warrant and represent that:</h6>
                    <ul class="pb-5 text-lg font-medium ltr:pl-1 rtl:pr-1">
                        <li
                            class="relative before:absolute before:top-3 before:h-1.5 before:w-1.5 before:rounded-full before:bg-gray ltr:pl-4 ltr:before:left-0 rtl:pr-4 rtl:before:right-0"
                        >
                        ...
                        <li
                            class="relative before:absolute before:top-3 before:h-1.5 before:w-1.5 before:rounded-full before:bg-gray ltr:pl-4 ltr:before:left-0 rtl:pr-4 rtl:before:right-0"
                        >
                            The Comments do not invade any intellectual property right, including without limitation copyright, patent or trademark of
                            any
                        </li>
                    </ul>
                    <h6 class="pb-2 font-semibold text-black">Third party;</h6>
                    <ul class="pb-5 text-lg font-medium ltr:pl-1 rtl:pr-1">
                        <li
                            class="relative before:absolute before:top-3 before:h-1.5 before:w-1.5 before:rounded-full before:bg-gray ltr:pl-4 ltr:before:left-0 rtl:pr-4 rtl:before:right-0"
                        >
                    ...
                    <p class="text-lg font-medium">
                        You hereby grant Company Name a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit
                        any of your Comments in any and all forms, formats or media.
                    </p>
                </div>
                <div>
                    <h4 class="pb-5 text-xl font-bold text-black dark:text-white sm:text-2xl">Hyperlinking to our Content</h4>
                    <p class="pb-5 text-lg font-medium">The following organizations may link to our Website without prior written approval:</p>
                    <ul class="pb-5 text-lg font-medium">
                        <li
                            class="relative before:absolute before:top-3 before:h-1.5 before:w-1.5 before:rounded-full before:bg-gray ltr:pl-4 ltr:before:left-0 rtl:pr-4 rtl:before:right-0"
                        >
                    ...
                    <p class="text-lg font-medium">which may not hyperlink to our Web site.</p>
                </div>
            </div>
            --}}
        </div>
