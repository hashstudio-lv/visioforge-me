...
@section('content')
    <div class="-mt-[82px] flex-grow overflow-x-hidden lg:-mt-[106px]">
                ...
                <div class="container">
                    <div class="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
                        <div class="heading relative mb-0 text-center ltr:md:text-left rtl:md:text-right">
                            <h6>About Us</h6>
                            <h4 class="!text-white">About Plurk Technologies</h4>
                        </div>
                        <div class="relative mt-6 md:mt-0" data-aos="fade-left" data-aos-duration="1000">
                            ...
                            >
                                ...
                                />
                                <path
                                    d="M93.8772 180.749L108.042 191.568"
                                    stroke="white"
                                    stroke-width="0.75"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
        ...
        <section class="relative pt-14 lg:pb-48 lg:pt-[100px]">
            <div class="container relative z-[1]">
                <div class="text-center lg:w-1/2 ltr:lg:text-left rtl:lg:text-right">
                    ...
                    <a href="career.html" class="btn capitalize text-white">Join Our Team</a>
                </div>
            </div>
            <div class="bottom-0 ltr:right-0 rtl:left-0 lg:absolute" data-aos="fade-left" data-aos-duration="1000">
                <img src="assets/images/about-bg.png" alt="about-who-bg" class="rtl:rotate-y-180" />
            </div>
        </section>
            ...
            <div class="container relative z-[2] ltr:xl:pr-40 rtl:xl:pl-40">
                ...
                <div class="grid gap-[30px] sm:grid-cols-2 lg:grid-cols-3">
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        >
                                    <span class="flex h-[50px] w-[50px] min-w-[50px] items-center justify-center rounded-full bg-secondary text-lg text-white"
                                    >01</span
                                    >
                            <div>
        ...
        <section class="py-14 lg:py-[100px]">
            <div class="container">
                <div class="heading text-center lg:w-2/3 ltr:lg:text-left rtl:lg:text-right">
                    <h4 class="mb-5">Our Awards</h4>
                    <p class="text-lg leading-[23px]">
                        As the world's leading web & mobile app development company have been privileged to win
                        <span class="font-semibold text-black dark:text-white">13+ numerous awards</span> for our working process. We’re honored to be a
                ...
                <div class="grid gap-4 pt-5 sm:grid-cols-3 md:gap-[30px] lg:grid-cols-4 lg:pt-0">
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="assets/images/award1.png" alt="award" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="assets/images/award2.png" alt="award" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="assets/images/award3.png" alt="award" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="assets/images/award4.png" alt="award" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="assets/images/award5.png" alt="award" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="assets/images/award6.png" alt="award" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="assets/images/award7.png" alt="award" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="assets/images/award8.png" alt="award" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            >
                                ...
                                <div class="p-5 text-sm font-bold">
                                    ...
                                    <p class="line-clamp-4">
                                        Jira works well for Agile development projects for many reasons, including the ability to create Kanban and
                                        Scrum boards with sprint planning and issue time estimation capabilities.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="relative bg-black pb-[100px] pt-14 dark:bg-transparent lg:pb-[250px] lg:pt-20">
        ...
        <section class="relative overflow-x-hidden border-t-2 border-transparent py-14 dark:border-gray/20 lg:py-[100px]">
            <div class="container">
                <div class="relative">
                    <div class="relative xl:inline-block" data-aos="fade-down" data-aos-duration="1000">
                        <img src="assets/images/stay-text.png" alt="stay-text" class="left-1/2 mx-auto sm:absolute sm:-translate-x-1/2" />
                        <img src="assets/images/updated-text.png" alt="updated-text" class="mx-auto sm:pt-4 xl:mx-0" />
                    ...
                    <p class="pt-2 text-center text-lg font-bold text-gray-dark dark:text-white ltr:xl:text-left rtl:xl:text-right">
                        Enter your email address to register to our newsletter subscription delivered on a regular basis!
                    </p>
                    <form
                        action=""
                        class="relative z-[1] pt-[50px] text-center ltr:xl:text-left rtl:xl:text-right"
                        data-aos="fade-up"
            ...
            <div class="absolute bottom-20 ltr:left-0 rtl:right-0">
                <svg width="171" height="216" viewBox="0 0 171 216" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.06" d="M160.487 10.9038L47.9038 205.904L-64.6795 10.9038L160.487 10.9038Z" stroke="#7780A1" stroke-width="20" />
                </svg>
            </div>
        </section>
    </div>
