            ...
            <div class="flex flex-wrap mx-[-12px] items-center">
                <div class="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] px-[12px] max-w-full wow fadeInLeft">
                    <div class="title-style-one text-center xl:text-left lg:text-left">
                        <h2 class="main-title font-normal text-[64px] leading-[1.15em] tracking-[0px] m-0 font-Recoleta 2xl:text-[58px] lg:text-[48px] md:text-[34px] md:leading-[1.2em] sm:text-[34px] sm:leading-[1.2em] xsm:text-[34px] xsm:leading-[1.2em]">
                            {{ __('Delivering') }}
                            <span class="inline-block relative z-[1]">{{ __('powerful, high-quality') }} <span class="mark-bg absolute left-[-5px] -translate-y-2/4 w-[98%] h-[50px] z-[-1] top-2/4 md:h-[34px] sm:h-[34px] xsm:h-[34px]" style="background-color:#D6F9EF;"></span>
                            </span> {{ __('image generation services.') }}
                        </h2>
                ...
                <div class="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] px-[12px] max-w-full !ml-auto wow fadeInRight">
                    <p class=" text-[24px] 2xl:text-[22px] lg:text-[19px] md:text-[19px] sm:text-[19px] xsm:text-[19px] leading-[1.67em] text-center xl:text-left lg:text-left  md:pt-[30px] sm:pt-[30px] xsm:pt-[30px] !m-0">
                        {{ __('Shortsy.art provides cutting-edge AI tools that turn your ideas into stunning visuals — fast, flexible, and built for creators.') }}
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="feedback_slider_seven">
                    @foreach([
                        [
                            ...
                            'name' => 'Lena K.',
                            'position' => __('E-commerce Manager'),
                        ],
                        [
                        ...
                        [
                            ...
                            'name' => 'Diana S.',
                            'position' => __('Online Store Owner'),
                        ],
                        [
            ...
            <div class="flex flex-wrap mx-[-12px] items-center">
                <div class="xl:w-9/12 m-auto wow fadeInUp">
                    <div class="title-style-seven text-center pb-[120px] lg:pb-[50px] md:pb-[50px] sm:pb-[50px] xsm:pb-[50px]  wow fadeInUp">
                        <h2 class="main-title font-normal text-[64px] leading-[1.15em] tracking-[0px] m-0 font-Recoleta 2xl:text-[58px] lg:text-[48px] md:text-[34px] md:leading-[1.2em] sm:text-[34px] sm:leading-[1.2em] xsm:text-[34px] xsm:leading-[1.2em]">
                           {{ __('Got questions?') }} <br> {{ ("Well, we've got") }} <span class="relative inline-block">{{ __("answers") }} <img class=" absolute z-[-1] max-w-[113%] -translate-x-2/4 -translate-y-2/4 left-2/4 top-2/4" src="{{ asset('assets2/images/shape/shape_99.svg') }}" alt=""></span>
                        </h2>
                ...
                <div class="xl:w-9/12 lg:w-10/12 w-full flex-[0_0_auto] px-[12px] max-w-full m-auto wow fadeInUp">
                    <div class="accordion accordion-style-two border-b-[rgba(0,0,0,0.1)] border-b border-solid" id="accordionOne">
                        @foreach([
                                [
                                    'question' => __('What can I do with Shortsy image generation services?'),
                                    'answer' => __('You can create high-quality images from text prompts using advanced AI. Whether you need realistic scenes, abstract visuals, or branded content, the tools allow you to generate visuals tailored to your creative needs.')
                                ],
                                [
                                    'question' => __('How does Text-to-Image work?'),
                                    'answer' => __('Simply enter a descriptive text prompt, and the AI will generate an image based on your input. You can guide the output using optional parameters like style, aspect ratio, or composition preferences.')
                                ],
                                [
                                    'question' => __('What is Text-to-PNG used for?'),
                                    'answer' => __('Text-to-PNG allows you to create images with transparent backgrounds, making them perfect for digital assets, marketing visuals, or overlays in designs. The output is instantly ready for use.')
                                ],
                                [
                                    'question' => __('Can I customize the style of the generated image?'),
                                    'answer' => __('Yes. You can choose from a variety of styles such as realistic, illustrated, minimal, or artistic. The generator adapts to your prompt and style settings for a unique result.')
                                ],
                                [
                                    'question' => __('Will I get the same image if I use the same prompt again?'),
                                    'answer' => __('Yes, using the same prompt and parameters will yield consistent results. This is useful when you need reliable, repeatable outputs for campaigns or multiple assets.')
                                ],
                                [
                                    'question' => __('Do I need any design or technical skills?'),
                                    'answer' => __('No design skills are required. Just describe your idea in plain language — the AI handles the rest. It’s made for creators of all experience levels.')
                                ],
                                [
                                    'question' => __('Who benefits from using image generation tools?'),
                                    'answer' => __('These tools are perfect for marketers, designers, developers, entrepreneurs, and content creators who need fast, high-quality visuals without hiring a designer or spending hours in editing software.')
                                ]
                        ] as $item)
