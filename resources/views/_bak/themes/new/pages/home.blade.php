    ...
    <div class="hero-banner-two relative pt-[250px] lg:pt-[200px] md:pt-[150px] sm:pt-[150px] xsm:pt-[150px]">
        ...
        Your Vision
                    ...
                    <p
                        ...
                        Generate stunning visuals from text, enhance your own images with powerful editing tools, or simply browse and buy ready-made AI art — all in one place.
                    </p>
                ...
                <div class="flex flex-wrap mx-[-12px]">
                    <div class="xl:w-3/12 lg:w-3/12 sm:w-6/12 w-full flex-[0_0_auto] px-[12px] max-w-full">
                        <div class="counter-block-five text-center mt-10  wow fadeInUp">
                            ...
                            <p class=" text-[18px] lg:text-[16px] md:text-[16px] sm:text-[16px] xsm:text-[16px] leading-[1.67em] mb-[15px]">AI-Generated Images Delivered</p>
                    ...
                    <div class="xl:w-3/12 lg:w-3/12 sm:w-6/12 w-full flex-[0_0_auto] px-[12px] max-w-full">
                        <div class="counter-block-five text-center mt-10  wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <p class=" text-[18px] lg:text-[16px] md:text-[16px] sm:text-[16px] xsm:text-[16px] leading-[1.67em] mb-[15px]">Transparent PNGs Created</p>
                    ...
                    <div class="xl:w-3/12 lg:w-3/12 sm:w-6/12 w-full flex-[0_0_auto] px-[12px] max-w-full">
                        <div class="counter-block-five text-center mt-10  wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <p class=" text-[18px] lg:text-[16px] md:text-[16px] sm:text-[16px] xsm:text-[16px] leading-[1.67em] mb-[15px]">Successful Edit Accuracy Rate.</p>
                    ...
                    <div class="xl:w-3/12 lg:w-3/12 sm:w-6/12 w-full flex-[0_0_auto] px-[12px] max-w-full">
                        <div class="counter-block-five text-center mt-10  wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <p class=" text-[18px] lg:text-[16px] md:text-[16px] sm:text-[16px] xsm:text-[16px] leading-[1.67em] mb-[15px]">AI Tools & Features Available</p>
                ...
                <div class="xl:w-7/12 lg:w-7/12 w-full flex-[0_0_auto] px-[12px] max-w-full !ml-auto xl:order-last lg:order-last">
                    <div class="block-style-one xxl:!pl-[3rem] wow fadeInRight">
                        <div class="title-style-one">
                            <div class="sc-title text-[16px] lg:text-[13px] md:text-[13px] sm:text-[13px] xsm:text-[13px]  tracking-[2px] text-[rgba(0,0,0,0.3)] mb-2">Perfect for design, marketing, or product visuals.</div>
                            <h2 class="main-title font-normal text-black !m- font-Recoleta">Providing <span class=" inline-block relative z-[1] before:content-[''] before:absolute before:w-[98%] before:h-3 before:z-[-1] before:left-1 before:bottom-2.5 before:bg-[rgba(255,139,37,0.4)]">Image Generation</span></h2>
                        </div> <!-- /.title-style-one -->
                        <p class="text-[24px] 2xl:text-[22px] lg:text-[19px] md:text-[19px] sm:text-[19px] xsm:text-[19px] leading-[1.67em] mb-[75px] pt-5 lg:mb-[50px] md:mb-[50px] sm:mb-[50px] xsm:mb-[50px] lg:pt-[10px] md:pt-[10px] sm:pt-[10px] xsm:pt-[10px] ">From words to visuals — powerful tools for unique creations.</p>
                        <ul class=" mb-0 pl-0 list-none list-item text-[18px] lg:text-[16px] md:text-[16px] sm:text-[16px] xsm:text-[16px] leading-[1.67em] mb-[50px] lg:mb-[30px] md:mb-[30px] sm:mb-[30px] xsm:mb-[30px]">
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">Text-to-Image Creation.</li>
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">Customizable Styles & Formats.</li>
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">Transparent PNG Output.</li>
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">Consistent & Predictable Results.</li>
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">Instant Delivery & Full Usage Rights.</li>
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">High-Resolution Outputs.</li>
                        </ul>
                        <div>
                            <a href="{{ route('pages.image-generation') }}" class="tran3s text-[17px] font-medium btn-three mb-[25px] ml-[.5rem] !mr-[1rem] text-white leading-[52px] relative transition-all duration-[0.3s] ease-[ease-in-out] p-[0_40px] rounded-[28px] bg-[var(--prime-two)] hover:bg-[#090F32] md:p-[0_35px] md:leading-[48px] sm:p-[0_35px] sm:leading-[48px] xsm:p-[0_35px] xsm:leading-[48px] lg:text-[15px] md:text-[15px] sm:text-[15px] xsm:text-[15px]">
                ...
                <div class="flex flex-wrap mx-[-12px] items-center">
                    <div class="xl:w-6/12 lg:w-6/12 md:w-7/12 sm:w-7/12 w-full flex-[0_0_auto] px-[12px] max-w-full">
                        <div class="title-style-one xsm:text-center text-left xsm:mb-[30px]">
                            <h2 class="main-title font-bold text-black !m-0">Browse the <span class=" inline-block relative z-[1] before:content-[''] before:absolute before:w-[98%] before:h-3 before:z-[-1] before:left-1 before:bottom-2.5 before:bg-[rgba(255,139,37,0.4)]">AI-generated creatives.</span>.</h2>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="flex flex-wrap mx-[-12px]">
                ...
                <div class="xl:w-6/12 lg:w-6/12 md:w-10/12 flex-[0_0_auto] px-[12px] max-w-full xl:order-first lg:order-first wow fadeInLeft">
                    <div class="block-style-one xxl:!pl-[3rem] wow fadeInRight">
                        <div class="title-style-one">
                            <div class="sc-title text-[16px] lg:text-[13px] md:text-[13px] sm:text-[13px] xsm:text-[13px]  tracking-[2px] text-[rgba(0,0,0,0.3)] mb-2">Perfect for e-commerce, content, or digital design.</div>
                            <h2 class="main-title font-normal text-black !m-0 font-Recoleta">Providing <span class=" inline-block relative z-[1] before:content-[''] before:absolute before:w-[98%] before:h-3 before:z-[-1] before:left-1 before:bottom-2.5 before:bg-[rgba(255,139,37,0.4)]">Image Editing</h2>
                        </div>
                        <p class=" text-[24px] 2xl:text-[22px] lg:text-[19px] md:text-[19px] sm:text-[19px] xsm:text-[19px] leading-[1.67em] text-black pt-[60px] pb-[45px] lg:pt-[30px] md:pt-[30px] sm:pt-[30px] xsm:pt-[30px] lg:pb-[10px] md:pb-[10px] sm:pb-[10px] xsm:pb-[10px] ">Enhance, transform, and refine your visuals with precision AI tools.</p>
                        <ul class=" mb-0 pl-0 list-none list-item text-[18px] lg:text-[16px] md:text-[16px] sm:text-[16px] xsm:text-[16px] leading-[1.67em] mb-[50px] lg:mb-[30px] md:mb-[30px] sm:mb-[30px] xsm:mb-[30px]">
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">Background Removal in Seconds.</li>
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">AI-Powered Image Upscaling.</li>
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">Generative Fill & Smart Retouching.</li>
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">Resize & Expand with Visual Consistency.</li>
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">Clean, Transparent PNG Exports.</li>
                            <li class=" relative mb-[15px] pl-[30px] before:content-['\f633'] before:text-[13px] before:absolute before:text-[color:var(--prime-one)] before:left-0 before:top-1.5 before:!font-Bootstrap">Professional-Grade Quality Enhancements.</li>
                        </ul>
                    ...
                    <div class="feedback_slider_two">
                        @foreach([
                            [
                                ...
                                'review' => 'Shortsy text-to-image tool has completely transformed our content creation process. It saves us so much time, and the quality is consistently outstanding.'
                            ],
                            [
                                'name' => 'Marco Bennett',
                                'position' => 'E-commerce Photographer',
                                'review' => 'The background remover is incredibly precise. What used to take 20 minutes per image now takes just a few seconds — and looks better.'
                            ],
                            [
                                'name' => 'Tomáš Novak',
                                'position' => 'App UI Designer',
                                'review' => 'I use the image generation service to quickly test visual ideas during the design phase — it’s like having a creative assistant on demand.'
                            ],
                            [
                                'name' => 'Julia K.',
                                'position' => 'Creative Director',
                                'review' => 'We rely on the upscaling and retouch tools for campaign assets. The results are sharp, clean, and perfectly aligned with our brand quality.'
                            ],
                        ] as $item)
                        <div class="item">
            ...
            <div class="flex flex-wrap mx-[-12px]">
                <div
                    ...
                    <div class="title-style-three text-center wow fadeInUp">
                        <h2
                            class="font-Recoleta main-title font-normal text-[64px] leading-[1.15em] tracking-[0px] m-0 2xl:text-[58px] lg:text-[48px] md:text-[34px] md:leading-[1.2em] sm:text-[34px] sm:leading-[1.2em] xsm:text-[34px] xsm:leading-[1.2em]">
                            Ready to create something <span class="inline-block relative z-[1]">amazing? <span
                    ...
                    <p class=" text-[24px] 2xl:text-[22px] lg:text-[19px] md:text-[19px] sm:text-[19px] xsm:text-[19px] leading-[1.67em] text-black pt-[30px] pb-[55px] lg:pb-[30px] md:pb-[30px] sm:pb-[30px] xsm:pb-[30px] wow fadeInUp"
                       data-wow-delay="0.1s">Start your creative journey — it only takes a moment.</p>
