            ...
            <div class="flex flex-wrap mx-[-12px] items-center">
                <div class="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] px-[12px] max-w-full wow fadeInLeft">
                    <div class="title-style-one text-center xl:text-left lg:text-left">
                        <h2 class="main-title font-normal text-[64px] leading-[1.15em] tracking-[0px] m-0 font-Recoleta 2xl:text-[58px] lg:text-[48px] md:text-[34px] md:leading-[1.2em] sm:text-[34px] sm:leading-[1.2em] xsm:text-[34px] xsm:leading-[1.2em]">
                            Delivering
                            <span class="inline-block relative z-[1]">smart, high-quality <span class="mark-bg absolute left-[-5px] -translate-y-2/4 w-[98%] h-[50px] z-[-1] top-2/4 md:h-[34px] sm:h-[34px] xsm:h-[34px]" style="background-color:#D6F9EF;"></span>
                            </span> image editing services.
                        </h2>
                ...
                <div class="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] px-[12px] max-w-full !ml-auto wow fadeInRight">
                    <p class=" text-[24px] 2xl:text-[22px] lg:text-[19px] md:text-[19px] sm:text-[19px] xsm:text-[19px] leading-[1.67em] text-center xl:text-left lg:text-left  md:pt-[30px] sm:pt-[30px] xsm:pt-[30px] !m-0">
                        Shortsy.art offers advanced AI-powered tools that simplify and elevate your creative workflow — fast, accurate, and built for creators.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-wrap mx-[-12px] items-center">
                ...
                <div class="xl:w-9/12 lg:w-10/12 w-full flex-[0_0_auto] px-[12px] max-w-full m-auto wow fadeInUp">
                    <div class="accordion accordion-style-two border-b-[rgba(0,0,0,0.1)] border-b border-solid" id="accordionOne">
                        @foreach([
                            [
                                'question' => 'What can I do with Shortsy image editing services?',
                                'answer' => 'You can remove backgrounds, upscale image quality, extend images, and even add or change parts of an image — all powered by AI. These tools help you achieve clean, high-resolution, and professional visuals in just a few clicks.'
                            ],
                            [
                                'question' => 'How does the Background Remover work?',
                                'answer' => 'The Background Remover isolates the main subject in your image by erasing the background automatically. It’s perfect for product photos, profile pictures, or any image where you need a clean cutout.'
                            ],
                            [
                                'question' => 'What’s special about the Creative Upscale tool?',
                                'answer' => 'Creative Upscale not only enlarges your image but also enhances textures, sharpness, and color richness. It produces high-resolution results that look sharper and more visually impressive than standard resizing tools.'
                            ],
                            [
                                'question' => 'What is Generative Fill used for?',
                                'answer' => 'Generative Fill lets you add or replace elements in your image using AI. For example, you can remove an object or add new ones, and the tool will blend everything naturally to match the original style.'
                            ],
                            [
                                'question' => 'How does Image Upscale help me?',
                                'answer' => 'Image Upscale increases the canvas of your image — great for making it fit new formats or layouts. It generates matching surroundings so the extended parts blend seamlessly with the rest of the image.'
                            ],
                            [
                                'question' => 'Do I need design skills to use these services?',
                                'answer' => 'Not at all. All tools are designed to be user-friendly. You simply upload an image, make your selection, and let the AI handle the editing. No technical or design experience needed.'
                            ],
                            [
                                'question' => 'Who should use these image editing tools?',
                                'answer' => "These services are ideal for e-commerce sellers, designers, marketers, content creators, and anyone who needs polished visuals — fast. Whether you're prepping product images or creating social media content, these tools save time and boost quality."
                            ]
                        ] as $item)
