        ...
        <div class="flex flex-wrap mx-[-12px]">
            <div class="xxl:w-7/12 xl:w-8/12 lg:w-8/12 md:w-9/12 w-full flex-[0_0_auto] px-[12px] max-w-full m-auto text-center">
                <div class="title-style-three text-center wow fadeInUp">
                    <h2 class="main-title font-normal text-[64px] leading-[1.15em] tracking-[0px] m-0 font-Recoleta 2xl:text-[58px] lg:text-[48px] md:text-[34px] md:leading-[1.2em] sm:text-[34px] sm:leading-[1.2em] xsm:text-[34px] xsm:leading-[1.2em]">Deposit in
                ...
                <a
                    ...
                    data-wow-delay="0.1s"
                >
                    Change To {{ $currency == 'EUR' ? 'USD' : 'EUR' }}
                </a>
                @if ($errors->any())
                    @dd($errors)
                @endif
                <div class="subscribe-form m-auto wow fadeInUp max-w-[620px]" data-wow-delay="0.2s">
                    ...
                    >
                        ...
                        <div class="flex items-center mb-4 pl-2">
                            ...
                            >
                                I agree to <a href="#" class="text-[var(--prime-two)] hover:underline">Privacy Policy</a>,
                                <a href="#" class="text-[var(--prime-two)] hover:underline">Terms and Conditions</a>
                            </label>
                        </div>
