                ...
                <div class="mt-8 flex flex-wrap items-center gap-0">
                    ...
                    @if (request()->get("google-pay"))
                        ...
                        <div id="btn-google-pay">
                            ...
                            <div id="btn-bancontact">Bancontact</div>
                            <div id="btn-blik">BLIK</div>
                            <div id="btn-ideal">iDEAL</div>
                            <div id="btn-sofort">SOFORT</div>
                            <div id="btn-mbway">MBWAY</div>
                            <div id="btn-multibanco">MULTIBANCO</div>
                    @endif
                </div>
    ...
    <script>
        ...
        function updateCostDisplay() {
            if (selectedAmount !== null) {
                if (selectedAmount < 5 && amountInputContainer.style.display === 'block') {
                    costText.innerHTML =
                        `<span class="text-red-500">Minimum 5 tokens required (Current: ${selectedAmount} tokens)</span>`;
                } else {
                    const cost = calculateFinalCost();

                    // to prevent something like "NaN $"...
                    if (! cost) {
                        return;
                    }
