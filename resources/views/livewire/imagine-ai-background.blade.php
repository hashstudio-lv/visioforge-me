                        ...
                        <div class="input-group-meta form-group mb-[30px]">
                            <div class="block">
                                ...
                                <label for="fileUpload"
                                       class="cursor-pointer block w-full max-w-full text-black text-[17px] pl-5 pr-[5px] py-[15px] rounded-lg border-2 border-solid border-black placeholder:text-black">
                                    Upload File
                                </label>
