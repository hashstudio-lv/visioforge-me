<div>
    ...
    {{--            @foreach(\App\Enums\ProductCategory::cases() as $style)--}}
    ...
    <div class="form-group mb-2">
        ...
        <select wire:model="format" class="form-control" @if($balance <= 0) disabled @endif>
    ...
    <div class="form-group mb-2">
        ...
        <select wire:model="size" class="form-control" @if($balance <= 0) disabled @endif>
    ...
    <div class="form-group mb-2">
        ...
        <input type="text" wire:model="title" class="form-control" @if($balance <= 0) disabled @endif>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea rows="5" wire:model="prompt" class="form-control" @if($balance <= 0) disabled @endif></textarea>
    </div>
